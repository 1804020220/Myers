...
public class MyersDiff<T> {
     ...
     * 默认相等规则
     */
    private final Comparator<T> DEFAULT_EQUALIZER = (original, revised) -> original.equals(revised) == true ? 0 : 1;

    private final Comparator<T> equalizer;

    public MyersDiff() {
        equalizer = DEFAULT_EQUALIZER;
    }

    public MyersDiff(Comparator<T> equalizer) {
